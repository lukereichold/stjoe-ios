...
#define kItemPadding 100 // was 30
...
- (void)drawRect:(CGRect)rect
{
  CGContextRef context = UIGraphicsGetCurrentContext();
	CGContextSetFillColorWithColor(context, [UIColor SJAGreen].CGColor);
  ...
  [_image drawInRect:CGRectMake(0, 9, 12, 7)];
    ...
    CGFloat topPadding = ([SJAUtils isIPAD]) ? 8 : 5;
    
  [_title drawInRect:CGRectMake(18, topPadding, [self titleWidth], 26) withFont:titleFont];
