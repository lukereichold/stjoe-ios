...
@interface CalendarJSONDataSource ()
- (NSArray *)holidaysFrom:(NSDate *)fromDate to:(NSDate *)toDate;
- (NSArray *)markedDatesFrom:(NSDate *)fromDate to:(NSDate *)toDate;
@end

@implementation CalendarJSONDataSource

@synthesize array;

+ (CalendarJSONDataSource *)dataSource
{
...
- (void)fetchHolidays {
    ...
    NSString *path = @"http://web.lukereichold.com/sluh/calendar/test.php";
