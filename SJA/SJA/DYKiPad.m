...
@property (nonatomic, strong) IBOutlet UITextView *funFactTextView;
...
- (void)viewDidLoad {
    ...
    [self.titleLabel setFont:[UIFont fontWithName:@"CopperplateGothicStd-31BC" size:40]];
...
- (IBAction)shuffleFacts {
	...
	self.funFactTextView.text = [self.facts objectAtIndex:random];
    self.funFactTextView.font = [UIFont systemFontOfSize:27.0];
}
...
- (void)layoutViewsForLandscape {
    self.imageView.frame = CGRectMake(189, 90, 645, 351);
    self.titleLabel.frame = CGRectMake(308, 454, 407, 64);
    self.funFactTextView.frame = CGRectMake(20, 508, 984, 145);
    self.nextButton.frame = CGRectMake(381, 651, 261, 71);
    self.nextLabel.frame = CGRectMake(254, 705, 516, 57);
}

- (void)layoutViewsForPortrait {
    self.imageView.frame = CGRectMake(65, 96, 640, 390);
    self.titleLabel.frame = CGRectMake(181, 497, 407, 64);
    self.funFactTextView.frame = CGRectMake(20, 552, 728, 298);
    self.funFactTextView.frame = CGRectMake(20, 552, 728, 298);
    self.nextButton.frame = CGRectMake(253, 872, 261, 71);
    self.nextLabel.frame = CGRectMake(128, 940, 516, 57);
}
...
- (void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation {
    ...
    if ([SJAUtils isLandscape:fromInterfaceOrientation]) {
        self.imageView.frame = CGRectMake(65, 96, 640, 390);
    } else {
        self.imageView.frame = CGRectMake(189, 90, 645, 351);
    }
