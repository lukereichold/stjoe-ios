...
- (id)initWithURL:(NSURL *)url title:(NSString *)title {
    ...
    if (self == [super init]) {
        ...
        self.applicationActivities = @[activity];
...
- (UIImage *)rightTriangleImage
{
    ...
    dispatch_once(&predicate, ^{
        ...
        UIBezierPath *path = [UIBezierPath bezierPath];
        [path moveToPoint:CGPointMake(14.0f, 8.0f)];
...
- (NSUInteger)supportedInterfaceOrientations {
    ...
    return ([SJAUtils isIPAD]) ? UIInterfaceOrientationMaskAll : (UIInterfaceOrientationMaskPortrait | UIInterfaceOrientationMaskPortraitUpsideDown);
}
